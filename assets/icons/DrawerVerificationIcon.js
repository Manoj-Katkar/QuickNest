...
const DrawerVerificationIcon = (props) => (
  <Svg
    width={24}
    height={24}
    viewBox="0 0 24 24"
  ...
  >
    ...
    />
    <Path
      d="M20.5 20V17C20.5 15.5706 19.1569 14 17.5 14C15.8431 14 14.5 15.5706 14.5 17V20.5C14.5 21.3284 15.1716 22 16 22C16.8284 22 17.5 21.3284 17.5 20.5V17"
      stroke="#F5F5F5"
      strokeWidth={1.5}
      strokeLinecap="round"
      strokeLinejoin="round"
...
export default DrawerVerificationIcon;
